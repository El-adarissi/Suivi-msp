...
export default function DashboardLayoutSup() {
  ...
  const navigationItems = [
    { id: "profilesup", label: "Informations Personnelles" },
    { id: "stagiairessup", label: "Stagiaires Encadrés" },
    { id: "rapportsstagsup", label: "Rapports des stagiaires" },
  ];
  const handleLogout = () => {
